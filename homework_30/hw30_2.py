...
# Modify the `build_parse_tree`
# and `evaluate functions
# to handle boolean statements ( and , or , and not).
# Remember that “not” is a unary operator,
# so this will somewhat complicate your code.
...
if __name__ == "__main__":
    pt: BinaryTree = build_parse_tree("( 0 or 1 )")
    print(evaluate(pt))
    print()
    pt.pre_order()
    print()
